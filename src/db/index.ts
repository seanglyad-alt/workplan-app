...
export async function initDbSchema() {
  ...
  const migrations = [
    ...
    `ALTER TABLE page_settings ADD COLUMN developer_name TEXT;`,
    `ALTER TABLE page_settings ADD COLUMN developer_telegram_link TEXT;`,
    `ALTER TABLE page_settings ADD COLUMN footer_app_name TEXT;`,
    `ALTER TABLE page_settings ADD COLUMN footer_copyright_year TEXT;`,
    `ALTER TABLE page_settings ADD COLUMN footer_copyright_text TEXT;`,
    `ALTER TABLE page_settings ADD COLUMN footer_badge1 TEXT;`,
    `ALTER TABLE page_settings ADD COLUMN footer_badge2 TEXT;`,
    `ALTER TABLE page_settings ADD COLUMN footer_show_clock INTEGER DEFAULT 1;`,
    `ALTER TABLE page_settings ADD COLUMN footer_show_date INTEGER DEFAULT 1;`,
    `ALTER TABLE page_settings ADD COLUMN footer_is_sticky INTEGER DEFAULT 0;`,
